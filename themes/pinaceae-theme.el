;;; pinaceae-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme pinaceae "Theme using Template variables with quality of life improvements.")
...
(let* ((bg "#131314")
      ...
      (on-primary "#253239")
      (on-primary-container "#d7e4ee")
      (on-secondary "#2a3136")
      (on-secondary-container "#dce3e9")
      (on-surface "#e4e2e3")
      (on-surface-variant "#c7c6c7")
      (on-tertiary "#1f333d")
      (on-tertiary-container "#d1e6f3")
      (outline-color "#919091")
      (outline-variant "#464747")
      (primary "#bbc8d2")
      (primary-container "#3c4950")
      (secondary "#c0c7cd")
      ...
      (tertiary "#b5c9d7")
      (tertiary-container "#364954")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#b5c9d7")
      (on-success "#1f333d")
      (success-container "#364954")
      (on-success-container "#d1e6f3")
      ;; Map fixed colors to regular colors
      (primary-fixed "#bbc8d2")
      (primary-fixed-dim "#3c4950")
      (secondary-fixed "#c0c7cd")
      (secondary-fixed-dim "#40484d")
      (tertiary-fixed "#b5c9d7")
      (tertiary-fixed-dim "#364954")
      (on-primary-fixed "#253239")
      (on-primary-fixed-variant "#d7e4ee")
      (on-secondary-fixed "#2a3136")
      (on-secondary-fixed-variant "#dce3e9")
      (on-tertiary-fixed "#1f333d")
      (on-tertiary-fixed-variant "#d1e6f3")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e4e2e3")
      (inverse-primary "#bbc8d2")
...
(provide-theme 'pinaceae)
;;; pinaceae-theme.el ends here
